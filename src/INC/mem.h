...
CD	*get_pc_from_id args( (long id) );
...
/* recycle object prototypes */
#define OID OBJ_INDEX_DATA
OID	*new_obj_index args( (void) );
void	free_obj_index args( (OBJ_INDEX_DATA *pObj) );
#undef OID

/* recycle mob prototypes */
...
GD	*new_guild args( (void) );
void	free_guild args( (GUILD_DATA *pGuild) );
#undef GD

/* recycle nodes */
#define ND NODE_DATA
ND	*new_node args( (void) );
void	free_node args( (NODE_DATA *node) );
#undef ND

/* recycle guards */
#define GD GUARD_DATA
GD	*new_guard args( (void) );
void	free_guard args( (GUARD_DATA *guard) );
#undef GD

#define GD GUILD
GD	*new_char_guild	args( (void) );
void	free_char_guild args( (GUILD *pGuild) );
void	add_guild args( (CHAR_DATA *ch) );
#undef GD

#define TD TEXT_DATA
TD	*new_text args( (void) );
void	free_text args( (TEXT_DATA *text) );
#undef TD
/* buffer procedures */
