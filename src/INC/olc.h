...
DECLARE_OLC_FUN( aedit_format		);
DECLARE_OLC_FUN( aedit_delete		);
DECLARE_OLC_FUN( aedit_climate		);
DECLARE_OLC_FUN( aedit_terrain		);
...
DECLARE_OLC_FUN( oedit_value7		);  /* ROM */
DECLARE_OLC_FUN( oedit_weight		);
DECLARE_OLC_FUN( oedit_cost		);
DECLARE_OLC_FUN( oedit_ed		);
DECLARE_OLC_FUN( oedit_qp		);
...
DECLARE_OLC_FUN( oedit_max		);  /* Eltan */
DECLARE_OLC_FUN( oedit_ocopy		);  /* Eltan */
...
DECLARE_OLC_FUN( medit_guild		);  /* Eltan */
DECLARE_OLC_FUN( medit_max		);  /* Eltan */
DECLARE_OLC_FUN( medit_mcopy		);  /* Eltan */
...
GUILD_DATA	*new_guild		args ( ( void ) );
